...
const projects = [
  {
    title: "SoFarCrypto",
    overview:
      "crypto news Reports from all around the world. news is fetches from diffrent sources using APIs.",
    stack: ["express js", "react", "Rest api", "tailwind"],
    link: null,
    repo: null,
    isSiteLive: false,
  },
...
export default function Home() {
  ...
  return (
    ...
    >
      <Head>
        <title>Divyansh Pal | Frontend Developer & React</title>
        <meta
          name="description"
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col-reverse items-start w-full md:flex-row">
              <div className="flex flex-col w-full md:pr-8 md:w-3/5">
                <p className="text-lg">
                  Hello! I&apos;m Divyansh and I&apos;m a MERN stack developer,
                  designer and creator on social plateform, based in India.
                </p>
                <p className="text-lg">
                ...
                <p className="text-lg">
                  currently am in 2nd year of Bachelors degree in 
                  Computer Applications and looking for work opportunity.
                </p>
                <p className="text-lg">
                ...
                <p className="text-lg">
                  Alongside my design and development work, I love to create content
                   on twitter related to technologies or tech stacks. that i do to release dopamine.
                  {" "}
                  <a
                    href="https://twitter.com/_idivyansh"
                    target="_blank"
